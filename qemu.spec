...
%prep
%setup -q -n qemu-5.1.0
cd %{_builddir}/qemu-5.1.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
cp %{_builddir}/qemu-5.1.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/qemu/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/qemu-5.1.0/LICENSE %{buildroot}/usr/share/package-licenses/qemu/c690b05ff6431c277b59784e95169e0e0528a983
cp %{_builddir}/qemu-5.1.0/capstone/LICENSE.TXT %{buildroot}/usr/share/package-licenses/qemu/861af24907e399e873920dbbff1ea1dd73a9ba35
cp %{_builddir}/qemu-5.1.0/capstone/LICENSE_LLVM.TXT %{buildroot}/usr/share/package-licenses/qemu/afc034c0ae47cbd47a99c6c5992d846511bb33ad
cp %{_builddir}/qemu-5.1.0/capstone/bindings/python/LICENSE.TXT %{buildroot}/usr/share/package-licenses/qemu/861af24907e399e873920dbbff1ea1dd73a9ba35
cp %{_builddir}/qemu-5.1.0/disas/libvixl/LICENCE %{buildroot}/usr/share/package-licenses/qemu/25383eb1c76eae5993e92a1cf2b75d58e599bbf5
cp %{_builddir}/qemu-5.1.0/dtc/README.license %{buildroot}/usr/share/package-licenses/qemu/a6759c569917866b44961c88629ae4f3f07ea686
cp %{_builddir}/qemu-5.1.0/roms/QemuMacDrivers/COPYING %{buildroot}/usr/share/package-licenses/qemu/2b9d60c2972b476384af9900276837ac81954e80
cp %{_builddir}/qemu-5.1.0/roms/SLOF/LICENSE %{buildroot}/usr/share/package-licenses/qemu/e1f0ad62e4850a19b1f56b821f37fccbf84ec191
cp %{_builddir}/qemu-5.1.0/roms/edk2/ArmPkg/Library/ArmSoftFloatLib/berkeley-softfloat-3/COPYING.txt %{buildroot}/usr/share/package-licenses/qemu/c4cd5ba6f665cf9ecb44e0620c2c76140566cfc6
cp %{_builddir}/qemu-5.1.0/roms/edk2/BaseTools/Source/C/BrotliCompress/LICENSE %{buildroot}/usr/share/package-licenses/qemu/4763ba7dfa7730d98b190dd8a4a2c6818d301fcb
cp %{_builddir}/qemu-5.1.0/roms/edk2/CryptoPkg/Library/OpensslLib/openssl/LICENSE %{buildroot}/usr/share/package-licenses/qemu/607e96d7bc75d9f884a8e210d276cca4006e0753
cp %{_builddir}/qemu-5.1.0/roms/edk2/CryptoPkg/Library/OpensslLib/openssl/external/perl/Text-Template-1.46/COPYING %{buildroot}/usr/share/package-licenses/qemu/ab8577d3eb0eedf3f98004e381a9cee30e7224e1
cp %{_builddir}/qemu-5.1.0/roms/edk2/License-History.txt %{buildroot}/usr/share/package-licenses/qemu/1b5c06f43bf6e2039065b681398f6b99a4d552f8
cp %{_builddir}/qemu-5.1.0/roms/edk2/License.txt %{buildroot}/usr/share/package-licenses/qemu/7fc5c71d1c403b07043376504d62f2ac73a75313
cp %{_builddir}/qemu-5.1.0/roms/edk2/MdeModulePkg/Library/BrotliCustomDecompressLib/LICENSE %{buildroot}/usr/share/package-licenses/qemu/4763ba7dfa7730d98b190dd8a4a2c6818d301fcb
cp %{_builddir}/qemu-5.1.0/roms/edk2/MdeModulePkg/Universal/RegularExpressionDxe/Oniguruma/COPYING %{buildroot}/usr/share/package-licenses/qemu/e9d39a1c2bd8459631ec9ec42761fe847ae93f3f
cp %{_builddir}/qemu-5.1.0/roms/edk2/OvmfPkg/License.txt %{buildroot}/usr/share/package-licenses/qemu/c9c057d4dc70e7a834d80b762663ca01a852ed13
cp %{_builddir}/qemu-5.1.0/roms/ipxe/COPYING %{buildroot}/usr/share/package-licenses/qemu/cedc99c80ddc135681756e652d55c72d89ebdfe7
cp %{_builddir}/qemu-5.1.0/roms/ipxe/COPYING.GPLv2 %{buildroot}/usr/share/package-licenses/qemu/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/qemu-5.1.0/roms/ipxe/src/include/ipxe/efi/LICENCE %{buildroot}/usr/share/package-licenses/qemu/ca46b2cea92edc93654b11c06c0073ec1a2e50e8
cp %{_builddir}/qemu-5.1.0/roms/openbios/COPYING %{buildroot}/usr/share/package-licenses/qemu/8b35225cbdbd6858fb081817cc9dbfe4bef26f5b
cp %{_builddir}/qemu-5.1.0/roms/openbios/Documentation/kernel/COPYING %{buildroot}/usr/share/package-licenses/qemu/e9b568889ca9075b505c509f7a877a723cc9a4b0
cp %{_builddir}/qemu-5.1.0/roms/openbios/utils/devbios/COPYING %{buildroot}/usr/share/package-licenses/qemu/7475b0da13789cd598fe0703f5337d37dd8b0b95
cp %{_builddir}/qemu-5.1.0/roms/opensbi/COPYING.BSD %{buildroot}/usr/share/package-licenses/qemu/0a0d7ae8e993794ae9c9ac5219c3d2bbf289471f
cp %{_builddir}/qemu-5.1.0/roms/qboot/LICENSE %{buildroot}/usr/share/package-licenses/qemu/30a6e0a424471d8ac874b5616dd5a18c45fd6046
cp %{_builddir}/qemu-5.1.0/roms/qemu-palcode/COPYING %{buildroot}/usr/share/package-licenses/qemu/2b9d60c2972b476384af9900276837ac81954e80
cp %{_builddir}/qemu-5.1.0/roms/seabios-hppa/COPYING %{buildroot}/usr/share/package-licenses/qemu/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/qemu-5.1.0/roms/seabios-hppa/COPYING.LESSER %{buildroot}/usr/share/package-licenses/qemu/e7d563f52bf5295e6dba1d67ac23e9f6a160fab9
cp %{_builddir}/qemu-5.1.0/roms/seabios/COPYING %{buildroot}/usr/share/package-licenses/qemu/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/qemu-5.1.0/roms/seabios/COPYING.LESSER %{buildroot}/usr/share/package-licenses/qemu/e7d563f52bf5295e6dba1d67ac23e9f6a160fab9
cp %{_builddir}/qemu-5.1.0/roms/sgabios/COPYING %{buildroot}/usr/share/package-licenses/qemu/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/qemu-5.1.0/roms/skiboot/LICENCE %{buildroot}/usr/share/package-licenses/qemu/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/qemu-5.1.0/roms/skiboot/ccan/array_size/LICENSE %{buildroot}/usr/share/package-licenses/qemu/3e8117303a7ac9ce341dc761b8a4f5ac3696e0a3
cp %{_builddir}/qemu-5.1.0/roms/skiboot/ccan/build_assert/LICENSE %{buildroot}/usr/share/package-licenses/qemu/3e8117303a7ac9ce341dc761b8a4f5ac3696e0a3
cp %{_builddir}/qemu-5.1.0/roms/skiboot/ccan/check_type/LICENSE %{buildroot}/usr/share/package-licenses/qemu/3e8117303a7ac9ce341dc761b8a4f5ac3696e0a3
cp %{_builddir}/qemu-5.1.0/roms/skiboot/ccan/container_of/LICENSE %{buildroot}/usr/share/package-licenses/qemu/3e8117303a7ac9ce341dc761b8a4f5ac3696e0a3
cp %{_builddir}/qemu-5.1.0/roms/skiboot/ccan/endian/LICENSE %{buildroot}/usr/share/package-licenses/qemu/3e8117303a7ac9ce341dc761b8a4f5ac3696e0a3
cp %{_builddir}/qemu-5.1.0/roms/skiboot/ccan/list/LICENSE %{buildroot}/usr/share/package-licenses/qemu/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
cp %{_builddir}/qemu-5.1.0/roms/skiboot/ccan/short_types/LICENSE %{buildroot}/usr/share/package-licenses/qemu/3e8117303a7ac9ce341dc761b8a4f5ac3696e0a3
cp %{_builddir}/qemu-5.1.0/roms/skiboot/ccan/str/LICENSE %{buildroot}/usr/share/package-licenses/qemu/3e8117303a7ac9ce341dc761b8a4f5ac3696e0a3
cp %{_builddir}/qemu-5.1.0/roms/u-boot-sam460ex/COPYING %{buildroot}/usr/share/package-licenses/qemu/11bb99995c221415712bb5a6d6c0898f02936feb
cp %{_builddir}/qemu-5.1.0/roms/u-boot-sam460ex/board/ACube/bios_emulator/scitech/src/x86emu/LICENSE %{buildroot}/usr/share/package-licenses/qemu/3f226d574cd9547c3e4d934bb1ac4be3601a9782
cp %{_builddir}/qemu-5.1.0/roms/u-boot-sam460ex/fs/jffs2/LICENCE %{buildroot}/usr/share/package-licenses/qemu/2f02ed32418afe8cc25f30f269c63085bafe44f7
cp %{_builddir}/qemu-5.1.0/roms/u-boot/cmd/license.c %{buildroot}/usr/share/package-licenses/qemu/33e557c1f30d0d1f1f585cb49686b8c13e47ba83
cp %{_builddir}/qemu-5.1.0/roms/u-boot/fs/jffs2/LICENCE %{buildroot}/usr/share/package-licenses/qemu/2f02ed32418afe8cc25f30f269c63085bafe44f7
cp %{_builddir}/qemu-5.1.0/slirp/COPYRIGHT %{buildroot}/usr/share/package-licenses/qemu/051935530e6be28baed83b2aafe66ee5b347d656
cp %{_builddir}/qemu-5.1.0/tests/fp/berkeley-softfloat-3/COPYING.txt %{buildroot}/usr/share/package-licenses/qemu/c4cd5ba6f665cf9ecb44e0620c2c76140566cfc6
cp %{_builddir}/qemu-5.1.0/tests/fp/berkeley-testfloat-3/COPYING.txt %{buildroot}/usr/share/package-licenses/qemu/b91b6ebd4f4725457f64e1d35e5a94c2bd35bcec
cp %{_builddir}/qemu-5.1.0/tests/uefi-test-tools/LICENSE %{buildroot}/usr/share/package-licenses/qemu/234e74aeab28f7faad2baccf1a3f943b36ab895e
cp %{_builddir}/qemu-5.1.0/ui/keycodemapdb/LICENSE.BSD %{buildroot}/usr/share/package-licenses/qemu/ea5b412c09f3b29ba1d81a61b878c5c16ffe69d8
cp %{_builddir}/qemu-5.1.0/ui/keycodemapdb/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/qemu/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
%make_install
%find_lang qemu
