...
Source0  : https://download.qemu.org/qemu-10.0.2.tar.xz
Source1  : https://download.qemu.org/qemu-10.0.2.tar.xz.sig
Source2  : 3353C9CEF108B584.pkey
Summary  : OPAL firmware
Group    : Development/Tools
License  : Apache-2.0 BSD-2-Clause BSD-2-Clause-Patent BSD-3-Clause CC0-1.0 GPL-2.0 GPL-2.0+ GPL-3.0 HPND LGPL-2.1 LGPL-2.1+ LGPL-3.0 MIT
...
%setup -q -n qemu-10.0.2
cd %{_builddir}/qemu-10.0.2
%patch -P 1 -p1
pushd ..
cp -a qemu-10.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748530222
...
cp %{_builddir}/qemu-%{version}/roms/skiboot/libmctp/LICENSE %{buildroot}/usr/share/package-licenses/qemu/fced88215cd27cefa3188261e6450c79ad0bf4c7 || :
...
/usr/share/package-licenses/qemu/fced88215cd27cefa3188261e6450c79ad0bf4c7
