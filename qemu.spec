...
Source0  : https://download.qemu.org/qemu-8.2.2.tar.xz
Source1  : https://download.qemu.org/qemu-8.2.2.tar.xz.sig
...
%prep
%setup -q -n qemu-8.2.2
cd %{_builddir}/qemu-8.2.2
%patch -P 1 -p1
pushd ..
cp -a qemu-8.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709658873
