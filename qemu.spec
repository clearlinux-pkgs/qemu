...
Source0  : https://download.qemu.org/qemu-9.0.2.tar.xz
Source1  : https://download.qemu.org/qemu-9.0.2.tar.xz.sig
...
%setup -q -n qemu-9.0.2
cd %{_builddir}/qemu-9.0.2
%patch -P 1 -p1
pushd ..
cp -a qemu-9.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721321760
