...
Version  : 2.5.1
Release  : 48
URL      : http://wiki.qemu-project.org/download/qemu-2.5.1.tar.bz2
Source0  : http://wiki.qemu-project.org/download/qemu-2.5.1.tar.bz2
...
Patch5: timer.patch
Patch6: qemu-0002-cache-CPUID.patch
Patch7: qemu-0004-disable-kvmvapic.patch
Patch8: qemu-0005-make-initialization-execute-in-parallel.patch
Patch9: qemu-0007-optimize-PAM.patch
