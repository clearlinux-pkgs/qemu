...
Source1  : https://download.qemu.org/qemu-8.2.1.tar.xz.sig
...
%prep
%setup -q -n qemu-8.2.1
cd %{_builddir}/qemu-8.2.1
%patch -P 1 -p1
pushd ..
cp -a qemu-8.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706573702
